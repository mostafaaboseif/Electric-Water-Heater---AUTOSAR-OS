...
# 28 "EcuAL/../MCAL/I2c.h"
# 1 "EcuAL/../MCAL/Port.h" 1
# 28 "EcuAL/../MCAL/Port.h"
...
# 4 "EcuAL/../MCAL/../std_types.h" 2


typedef unsigned char bool;
# 17 "EcuAL/../MCAL/../std_types.h"
...
# 35 "EcuAL/../MCAL/../std_types.h"
typedef uint8_t Std_ReturnType;
# 49 "EcuAL/../MCAL/../std_types.h"
enum {
Pin0,Pin1,Pin2,Pin3,Pin4,Pin5,Pin6,Pin7
};
# 28 "EcuAL/../MCAL/Port.h" 2



# 1 "EcuAL/../MCAL/../common_macros.h" 1
# 31 "EcuAL/../MCAL/Port.h" 2



# 1 "EcuAL/../MCAL/../micro_config.h" 1
...
# 34 "EcuAL/../MCAL/Port.h" 2



# 1 "EcuAL/../MCAL/../PreCompileConfig.h" 1
# 37 "EcuAL/../MCAL/Port.h" 2



# 1 "EcuAL/../MCAL/Dio.h" 1
# 28 "EcuAL/../MCAL/Dio.h"
# 1 "EcuAL/../MCAL/Port.h" 1
# 28 "EcuAL/../MCAL/Dio.h" 2
# 51 "EcuAL/../MCAL/Dio.h"
enum{
    DOWN_BUTTON_CHANNEL,
...
# 144 "EcuAL/../MCAL/Dio.h"
void Dio_WritePort ( Dio_PortType PortId, Dio_PortLevelType Level );
# 156 "EcuAL/../MCAL/Dio.h"
Dio_PortLevelType Dio_ReadPort ( Dio_PortType PortId );
# 40 "EcuAL/../MCAL/Port.h" 2

# 1 "EcuAL/../MCAL/interrupt.h" 1
# 22 "EcuAL/../MCAL/interrupt.h"
# 1 "EcuAL/../MCAL/Port.h" 1
# 22 "EcuAL/../MCAL/interrupt.h" 2
# 33 "EcuAL/../MCAL/interrupt.h"
typedef enum {
    TIMER,
    ADC,
    UART_TX,
...
# 41 "EcuAL/../MCAL/Port.h" 2

# 1 "EcuAL/../MCAL/../Det.h" 1
# 23 "EcuAL/../MCAL/../Det.h"
# 1 "./MCAL/Uart.h" 1
# 28 "./MCAL/Uart.h"
# 1 "EcuAL/../MCAL/Port.h" 1
...
# 42 "EcuAL/../MCAL/Port.h" 2
# 81 "EcuAL/../MCAL/Port.h"
...
Eep_ConfigType* Eep_ThisConfiguration = ((void *)0);
...
Std_ReturnType Eep_Write(Eep_AddressType EepromAddress, uint8* DataBufferPtr, Eep_LengthType Length)
{
    ...
    else if(EepromAddress > 0xFF )
    {
        Det_ReportError(0x090, 0x00,
        0x03,0x11);
    }
    else if(DataBufferPtr == ((void *)0))
    {
        Det_ReportError(0x090, 0x00,
        0x03,0x12);
    }
...

    {
       ...
       while(I2c_WriteSlaveAddress(0xA0))
...
Std_ReturnType Eep_Erase ( Eep_AddressType EepromAddress, Eep_LengthType Length )
{
    ...
    {
        uint8_t x = 0xFF;
        while(Eep_Write(EepromAddress,&x,Length) != ((Std_ReturnType)0x00u));
    }
    return ((Std_ReturnType)0x00u);
}
...
Std_ReturnType Eep_Compare ( Eep_AddressType EepromAddress, uint8* DataBufferPtr, Eep_LengthType Length )
{
    ...
    {
        uint8_t x;
        while(Eep_Read(EepromAddress,&x,Length) != ((Std_ReturnType)0x00u));
        if(x == *DataBufferPtr)
            return ((Std_ReturnType)0x00u);
        else
