   ...
   while(1)
    {
      ...
      {
            while(TempSensor_GetTemp(CurrentTemp) != ((Std_ReturnType)0x00u)){}
            (CurrentTempAverage=(CurrentTemp[0]+CurrentTemp[1]+CurrentTemp[2]+CurrentTemp[3]+CurrentTemp[4])/5);
