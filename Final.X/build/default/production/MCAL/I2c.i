...
I2c_ConfigType *I2c_ThisConfiguration = ((void *)0) ;
 ...
 if (Config_Ptr == ((void *)0))
  ...
  Det_ReportError(0x083, 0x00,
...

    {
        ...
        SSPCON |= 0x0F & Config_Ptr->I2c_Mode;
        (SSPCON|=(1<<5));
        SSPCON2 = 0;
        SSPADD = (10000000/(4*Config_Ptr->I2c_Baudrate))-1;
        SSPSTAT = 0;
