...
{
    GIE=0;
    while(Uart_WriteString("\nDEVELOPMENT_ERROR")!=((Std_ReturnType)0x00u)){}
    while(Uart_WriteString("\nModuleId: 0x")!=((Std_ReturnType)0x00u)){}
    Uart_WriteInt((uint8_t)ModuleId);
    Uart_WriteInt(ModuleId<<8);
    while(Uart_WriteString("\nInstanceId: 0x")!=((Std_ReturnType)0x00u)){}
    Uart_WriteInt(InstanceId);
    while(Uart_WriteString("\nApiId: 0x")!=((Std_ReturnType)0x00u)){}
    Uart_WriteInt(ApiId);
    while(Uart_WriteString("\nErrorId: 0x")!=((Std_ReturnType)0x00u)){}
